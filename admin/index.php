	...
	<div class="wrapper">
		...
		<div class="content_wrapper">
			<div class="right" style="background-image: url(images/right.jpg)">
					...
					<a href="index.php?view_trainers_users">View Trainers assigned to Users</a>
					...
					<a href="index.php?view_left_members">View left Members</a>
				...
				<!-- Product Display Box Start -->
					<div id="products_box">
						<?php
							...
							if (isset($_GET['view_left_members'])) {
								include("view_left_members.php");
							}
							if (isset($_GET['view_trainers_users'])) {
								include("view_trainers_users.php");
							}
