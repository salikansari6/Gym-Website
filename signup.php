...
//Sign Up Script Start
  if (isset($_POST['user_signup']))
  {
    ...
    elseif ($user_contact=='') {
      ...
      $insert_user="INSERT INTO users(user_name, user_email,user_pass,user_weight,user_age,user_contact,tran_id) VALUES('$user_name','$user_email','$user_password','$user_weight','$user_age','$user_contact',RAND()*10)";
